...
import 'package:Chit_Chat_app/services/database_service.dart';
import 'package:Chit_Chat_app/views/groups/chat_page.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  _initiateSearch() async {
    if(searchEditingController.text.isNotEmpty){
      ...
      await DatabaseMethods().searchByNames(searchEditingController.text).then((snapshot) {
      ...
      trailing: InkWell(
        onTap: () async {
          ...
          if(_isJoined) {
            ...
            // await DatabaseMethods(uid: _user.uid).userJoinGroup(groupId, groupName, userName);
